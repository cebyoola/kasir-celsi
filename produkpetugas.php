            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="prosestambahprodukpetugas.php" method="POST">
                            <div class="mb-3">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="editprodukpetugas.php?id=<?php echo $data['produkid']; ?>" class="btn btn-warning btn-sm">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                                <a href="proseshapusprodukpetugas.php?id=<?php echo $data['produkid']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin menghapus data produk?')">
